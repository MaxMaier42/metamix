...
#include "stanExports_selection_flexpb.h"

RCPP_MODULE(stan_fit4selection_flexpb_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_selection_flexpb")
