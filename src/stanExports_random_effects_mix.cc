...
#include "stanExports_random_effects_mix.h"

RCPP_MODULE(stan_fit4random_effects_mix_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_random_effects_mix")
