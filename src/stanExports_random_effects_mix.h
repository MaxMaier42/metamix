...
static constexpr std::array<const char*, 50> locations_array__ =
  ...
  " (in 'string', line 37, column 6 to column 88)",
  " (in 'string', line 36, column 19 to line 38, column 5)",
  " (in 'string', line 36, column 4 to line 38, column 5)",
  " (in 'string', line 41, column 6 to column 63)",
  " (in 'string', line 40, column 19 to line 42, column 5)",
  " (in 'string', line 40, column 4 to line 42, column 5)",
  " (in 'string', line 45, column 6 to column 38)",
  ...
  " (in 'string', line 51, column 4 to column 72)",
  " (in 'string', line 32, column 17 to line 53, column 3)",
  " (in 'string', line 32, column 2 to line 53, column 3)",
      ...
      for (int i = 1; i <= K; ++i) {
        ...
        for (int m = 1; m <= M; ++m) {
          ...
          stan::model::assign(resp,
            ...
            "assigning variable resp", stan::model::index_uni(m));
        }
        current_statement__ = 18;
        for (int m = 1; m <= M; ++m) {
          current_statement__ = 16;
          stan::model::assign(posterior_probs,
            stan::model::rvalue(resp, "resp", stan::model::index_uni(m)),
